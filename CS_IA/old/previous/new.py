...
image[62:62+84,23:23+371] = 255

cv2.imshow("no_title",cv2.resize(image,(image.shape[1]//2,image.shape[0]//2)))
cv2.waitKey()
...
for contour in contours:
    x,y,w,h = cv2.boundingRect(contour)
    if True or x < image.shape[1]/4 and y < image.shape[0]/2 and w > image.shape[1]/4 and h > avgBlockHeight:
