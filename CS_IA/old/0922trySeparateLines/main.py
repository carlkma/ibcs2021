...
def GUI():
    global root, progress1, progress2, lblPg1, lblPg2, listbox
    root = tk.Tk()
    ...
    listbox.insert(END, "AAAAAAAAAAA"+"\t"+"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAaAAAAAAAAAAAAAAAAAAA")
    listbox.insert(END, "")
    listbox.insert(END, "")
...
def main():
    global progress1, progress2, lblPg1, lblPg2, listbox
    docs = []
    file_name = []
    info = []
    global directory
    ...
    for page in docs:
        ...
        divided = []
        for line in output.adjustWidth(title, divided):
            print(divided, line)
            listbox.insert(END, str(count)+ " "+line)
